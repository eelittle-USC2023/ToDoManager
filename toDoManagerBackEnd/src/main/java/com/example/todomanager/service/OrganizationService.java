...
public class OrganizationService {
    ...
    public OrganizationService(OrganizationRepository orgRepo, UserRepository userRepo, RoleRepository roleRepo, RoleService roleService) {
    ...
    public Organization create(Organization organization, UUID creatingUserId) {
        ...
        roleService.create(ownerRole, creatingUserId);
