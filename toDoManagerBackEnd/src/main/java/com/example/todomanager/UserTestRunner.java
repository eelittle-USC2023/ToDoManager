...
public class UserTestRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        // 3️⃣ Test login
        Optional<User> userLoginSuccess = userService.login("testuser", "password123");
        System.out.println("Login success (correct password): " + userLoginSuccess.isPresent());

        Optional<User> userLoginFail = userService.login("testuser", "wrongpassword");
        System.out.println("Login success (wrong password): " + userLoginFail.isEmpty());
